    ...
    return (
        <div className='about-page'>
            <div className='about-container'>
                ...
                <br /><br />It's been a fun opportunity to expand my skill-set and build my experience in developing web applications. I plan to leave the project as an open sandbox with the idea to explore and implement ideas that spike my curiosity in the future.
