    ...
    return (
        <div className='about-page'>
            <div className='about-container'>
                ...
                Mern Social is a code project that aims to simulate a social media similar to Twitter, where users can create accounts, log in, and post short messages + media to share with others. Other interactions include mentions/tags, follows, likes and comments, which will all generate notifications.  
                <br /><br />The primary purpose of the project was to explore the JavaScript(MERN) ecosystem and improve my skills in React and API design. Where I could, I have minimized use of libraries to gain a more vanilla understanding of the technology. For example I was curious how production applications implement their login/refresh mechanism so the mechanism used in this site is written completely by me.
                <br /><br />I plan to leave the project as an open sandbox with the idea to explore and implement ideas that spike my curiosity in the future. Contributions welcome.
